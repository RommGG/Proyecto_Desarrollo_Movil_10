...
<div style="display: flex; justify-content: space-between; flex-wrap: wrap;">
    <img src="./img/results/Mockups/MLogin.png?raw=true" alt="img1" width="450" style="margin-bottom: 10px;" />
    <img src="./img/results/Mockups/MInicio.png?raw=true" alt="img2" width="450" style="margin-bottom: 10px;" />
</div>
<div style="display: flex; justify-content: space-between; flex-wrap: wrap;">
    <img src="./img/results/Mockups/MRegistros.png?raw=true" alt="img3" width="450" style="margin-bottom: 10px;" />
    <img src="./img/results/Mockups/MSeguimiento.png?raw=true" alt="img4" width="450" style="margin-bottom: 10px;" />
</div>
<div style="display: flex; justify-content: space-between; flex-wrap: wrap;">
    <img src="./img/results/Mockups/MEditar.png?raw=true" alt="img5" width="450" style="margin-bottom: 10px;" />
    <img src="./img/results/Mockups/MEstadisticas.png?raw=true" alt="img6" width="450" style="margin-bottom: 10px;" />
</div>
...
## AUTORES
- Elí Aidan Melo Calva [@EliAidan](https://github.com/EliAidan)
